...
public class simpleExecutor implements  Executor {
    ...
    public int insert(Configuration configuration, MappedStatement mappedStatement, Object[] params) throws Exception {
        PreparedStatement preparedStatement = prepare(configuration, mappedStatement, params);
    ...
    //获取链接，sql语句，解析sql
    public PreparedStatement prepare(Configuration configuration,MappedStatement mappedStatement,Object... params) throws Exception{
        // 1. 注册驱动，获取连接
